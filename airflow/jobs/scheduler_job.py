                ...
                if dag_run:
                    ...
                    if expected_start_date:
                        ...
                        Stats.timing(
                            ...
                            schedule_delay.total_seconds()*1000)
        ...
        while True:
            ...
            if os.path.exists(airflow_home + "/scheduler.restart"):
                try:
                    ...
                    self.log.info("Restart of scheduler triggered from update airflow")
                    break
                except:
                    self.log.info("Unable to delete the scheduler.restart file.")
