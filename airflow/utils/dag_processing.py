...
class DagFileProcessorManager(LoggingMixin):  # pylint: disable=too-many-instance-attributes
    ...
    def _refresh_dag_dir(self):
        ...
        if elapsed_time_since_refresh > self.dag_dir_list_interval or os.path.exists(airflow_home + "/scheduler.refresh"):
    ...
    def _log_file_processing_stats(self, known_file_paths):
        ...
        for file_path in known_file_paths:
            ...
            if runtime:
                Stats.timing('dag_processing.last_duration.{}'.format(file_name), runtime.total_seconds()*1000)
                # TODO: Remove before Airflow 2.0
                Stats.timing('dag_processing.last_runtime.{}'.format(file_name), runtime.total_seconds()*1000)
