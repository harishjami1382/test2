...
REMOTE_BASE_LOG_FOLDER: str = str(conf.get('logging', 'REMOTE_BASE_LOG_FOLDER')) + "/dag_logs"
...
DEFAULT_LOGGING_CONFIG: Dict[str, Any] = {
    ...
    'handlers': {
        ...
        'qds.task': {
            'class': 'airflow.utils.log.qds_task_handler.QDSTaskHandler',
            'formatter': 'airflow',
            'base_log_folder': os.path.expanduser(BASE_LOG_FOLDER),
            'qds_log_folder': REMOTE_BASE_LOG_FOLDER,
            'filename_template': FILENAME_TEMPLATE,
        },
        'processor': {
